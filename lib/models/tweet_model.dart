...
class Tweet {
  ...
  Tweet copyWith({
    ...
    return Tweet(
      ...
      reliedTo: reliedTo ?? this.reliedTo,
    );
  }
  ...
  Map<String, dynamic> toMap() {
    ...
    result.addAll({'reliedTo': reliedTo});
  ...
  factory Tweet.fromMap(Map<String, dynamic> map) {
    return Tweet(
      ...
      reliedTo: map['reliedTo'] ?? '',
    );
  }

  @override
  String toString() {
    return 'Tweet(text: $text, hashtags: $hashtags, link: $link, imageLinks: $imageLinks, uid: $uid, tweetType: $tweetType, tweetedAt: $tweetedAt, likes: $likes, commentIds: $commentIds, id: $id, reshareCount: $reshareCount, retweetedBy: $retweetedBy, reliedTo: $reliedTo)';
  }
